...
int main(int argc, char **argv)
{
    ...
    FILE * am_file;
    char * analyzer_tester_filename = (char*)calloc(MAX_FILE_NAME_LENGTH, sizeof(char));
    FILE * analyzer_tester_output;
    char line[MAX_LINE_LENGTH];
    Analyzed_line analyzed_line_result;


    am_filename = process_as_file(argv[1]);
    ...
    strcpy(analyzer_tester_filename, argv[2]);
    analyzer_tester_output = fopen(analyzer_tester_filename, "w");
